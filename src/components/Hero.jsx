    ...
    <main className="flex lg:mt-20 flex-col-reverse lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      <div className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        ...
        <p className=" text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
          the best way to reach humans instead of spam folders, dlever
      ...
      <Spline
        className="absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:1fet-[-2%] h-full"
        scene="https://prod.spline.design/oaGfM-PoGLMhixHo/scene.splinecode"
      />
    </main>
  );
};
